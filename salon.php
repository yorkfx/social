...
//Enviar Correo electronico al salon
...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
		...
		<meta property="og:url"           content="<?php echo 'http://'.$_SERVER["HTTP_HOST"].''.$_SERVER["PHP_SELF"].'?id='.$row_Recordset1['id'].'';?>" />
		...
		<meta property="og:description"   content="<?php echo $row_Recordset1['descripcion']; ?>" />
<?php
...
?>
		...
		<meta itemprop="description" content="<?php echo $row_Recordset1['descripcion']; ?>" />
